...
func AddNewVideo(aid int,name string)(*defs.VideoInfo,error){
	...
	stmtIns,err:=dbConn.Prepare(`INSERT INIO video_info (id,author_id,name,display_ctime) VALUES(?,?,?,?)`)
...
func GetVideoInfo (vid string)(* defs.VideoInfo,error){
	stmtOut,err:=dbConn.Prepare("SELECT author_id,name,display_ctime WHERE id=?")
...
func ListVideoInfo(uname string,from,to int)([]*defs.VideoInfo,error) {
	stmtOut, err := dbConn.Prepare(`SELECT video_info,video_info.author_id,video_info.name, video_info.display_ctime FROM
